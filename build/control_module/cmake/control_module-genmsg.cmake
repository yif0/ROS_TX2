...
set(MSG_I_FLAGS "-Icontrol_module:/home/nvidia/RosWorkspace/src/control_module/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nvidia/RosWorkspace/src/control_module/msg/Trajectory.msg" NAME_WE)
add_custom_target(_control_module_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control_module" "/home/nvidia/RosWorkspace/src/control_module/msg/Trajectory.msg" "control_module/CheckPoint"
)

get_filename_component(_filename "/home/nvidia/RosWorkspace/src/control_module/msg/CheckPoint.msg" NAME_WE)
add_custom_target(_control_module_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control_module" "/home/nvidia/RosWorkspace/src/control_module/msg/CheckPoint.msg" ""
)
...
_generate_msg_cpp(control_module
  "/home/nvidia/RosWorkspace/src/control_module/msg/Trajectory.msg"
  "${MSG_I_FLAGS}"
  "/home/nvidia/RosWorkspace/src/control_module/msg/CheckPoint.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/control_module)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/control_module\")")
  # install generated code
  install(
