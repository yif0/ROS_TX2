...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vicon_module-msg:<Position> is deprecated: use vicon_module-msg:Position instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_module-msg:x-val is deprecated.  Use vicon_module-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_module-msg:y-val is deprecated.  Use vicon_module-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_module-msg:theta-val is deprecated.  Use vicon_module-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_module-msg:speed-val is deprecated.  Use vicon_module-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_module-msg:steering-val is deprecated.  Use vicon_module-msg:steering instead.")
  (steering m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Position>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 theta~%int32 speed~%int32 steering~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Position)))
  "Returns full string definition for message of type 'Position"
  (cl:format cl:nil "float32 x~%float32 y~%float32 theta~%int32 speed~%int32 steering~%~%~%"))
